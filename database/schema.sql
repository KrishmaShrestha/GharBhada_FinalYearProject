...
-- MySQL Database for Rental Property Management System

-- Create database (run separately if needed)
-- CREATE DATABASE IF NOT EXISTS gharbhada;
-- USE gharbhada;
...
CREATE TABLE IF NOT EXISTS properties (
    ...
    lease_duration_min INT DEFAULT 1,
    lease_duration_max INT DEFAULT 5,
    electricity_rate DECIMAL(10, 2),
    water_charge DECIMAL(10, 2),
    garbage_charge DECIMAL(10, 2),
    house_rules TEXT,
